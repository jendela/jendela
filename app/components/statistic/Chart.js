            ...
            <div>
                ...
                <svg ref='svg'
                    ...
                    {data.map((d, idx) => {
                        ...
                        const line = isLast ? null : <line x1={10} y1={barHeight} x2={width-10} y2={barHeight} style={styles.line} />
                        ...
                        return (
                            <g key={idx} transform={`translate(0, ${(idx * barHeight)})`}>
                                ...
                                <rect x={xBar} y={barSpacing} width={x(d.value)} height={barHeight - (2 * barSpacing)} style={styles.bar} />
                                { line }
                            </g>
                        )
                    })}
