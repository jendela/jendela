      ...
      <section style={styles.container}>
        <div className="row">
          <div className="columns">
            ...
            <p style={styles.info}>Mempermudah Anda untuk mendapatkan informasi tentang layanan public, menulis ulasan,
              dan melihat ulasan dengan cepat bahkan ketika Anda sedang berada di kantor layanan publik!</p>
            ...
            <form action="//jende.us1.list-manage.com/subscribe/post?u=3a2c29fca637e81baaa0aef9f&amp;id=c424e8d863"
              ...
              <div className="row align-center">
                <div className="small-12 large-9 columns">
                  <input type="email" placeholder="Isi alamat email Anda di sini..." name="EMAIL"
