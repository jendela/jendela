  ...
  render() {
    ...
    let idnumberInput = (
      <ReviewInputRow title="NIK">
        <input
          value={this.state.idnumber} required type="text" placeholder="Nomer Induk Kependudukan (KTP / SIM)"
          id="idnumber"
          onChange={this._onChange.bind(this)}/>
      </ReviewInputRow>
    );

    identitasInput.push(<div style={styles.disclaimer}>Jika memutuskan untuk anonim, data personal dibawah ini tidak
      akan dipublikasikan di portal Jendela dan hanya akan dipakai untuk proses verifikasi</div>);
